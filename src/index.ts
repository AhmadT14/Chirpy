...
import { handlerUpdaterRedChirpy, handlerUpdateUserProfile, handlerUsersCreate } from "./api/users.js";
...
app.post("/api/polka/webhooks", (req, res, next) => {
  Promise.resolve(handlerUpdaterRedChirpy(req, res)).catch(next);
});
